    ...
    <div class=container-fluid>
        <div id="recomendados" class="row justify-content-center">
            <div id="recomendados-f" class="col-md-12 col-xl-3 col-12">
                <h1 style="font-size: calc(1em + 1vw)">SUGGESTIONS FOR YOU</h1><br>
                <a>A special selection on the best offers.</a>
...
$numero_filashh = mysqli_fetch_array($ejecutarinsertarhh);
            ...
            <div class="col-md-12 col-xl-12 col-12">
                <div class="row justify-content-center">
                    ...
                    <div id=texto-abajo-nav class="col-md-6 col-xl-6 col-8">
                        <a>Still paying for the room cost on your trips? Do you think you had a good bargain?
                            With flexidreams you pay a minimum consumption and you decide yourself how much to spend on the hotel.
                            In exchange, we gift you the complete room cost.
                        </a>
                    </div>
                </div>
                <div id=iconos-abajo-nav align=center class="row justify-content-center">
                    ...
                    <div class="col-md-12 col-xl-2 col-12">
                        ...
                        <a>FREE<br>LODGING</a><br><br>
                    </div>
                    <div class="col-md-12 col-xl-2 col-12">
                        <i class="fas fa-percent"></i><br>
                        <a>THE BEST<br>OFFERS</a><br><br>
                    </div>
                    <div class="col-md-12 col-xl-2 col-12">
                        <i class="fas fa-bed"></i><br>
                        <a>SELECTED<br>HOTELS</a><br><br>
                    </div>
                    <div class="col-md-12 col-xl-2 col-12">
                        <i class="far fa-lightbulb"></i><br>
                        <a>INSPIRATIONS</a><br><br>
                    </div>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            ...
            <div style="background-color:black;" class="col-md-12 col-xl-6 col-12">
                ...
                <div id="div-text-6">
                    <a>Descubra más&nbsp;&nbsp;<i class="fas fa-long-arrow-alt-right"></i>
