			...
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					<form action="../login-comprobar.php" method="post">
						<div class="input-group mb-3">
							...
							<input type="text" name="user" class="form-control input_user" value="" placeholder="user">
						</div>
						<div class="input-group mb-2">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-key"></i></span>
							</div>
							<input type="password" name="contrasena" class="form-control input_pass" value="" placeholder="password">
						</div>
				...
				<div class="mt-4">
					<div class="d-flex justify-content-center links">
						Don't have an account? <a href="#" class="ml-2">Register!</a>
					</div>
					<div class="d-flex justify-content-center links">
						<a href="#">Forgot the password?</a>
                    </div>
                    <div class="d-flex justify-content-center links">
                    Are you an hotel?<a  class="ml-2" href="form-hotel.php">Register here!</a>
					</div>
				</div>
			</div>
		</div>
