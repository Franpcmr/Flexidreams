...
echo 'var fechahoteldesde'. $numerocontador.' = new Date('.$numero_filashh['desde'].');
...
$numerocontador2 = 0;
    ...
    echo 'if (fechacontador == fechahotelconvertidadesde'. $numerocontador.') {

        if (fechahotelconvertidadesde'. $numerocontador.' < fechahotelconvertidahasta'. $numerocontador.') {
            fechahoteldesde'. $numerocontador.'.setDate(fechahoteldesde'. $numerocontador.'.getDate() + 1);
            fechahotelconvertidadesde'. $numerocontador.' = fechahoteldesde'. $numerocontador.'.toLocaleDateString("fr-CA");
        }  
