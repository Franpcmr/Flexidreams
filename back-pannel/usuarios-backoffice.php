...
<body onload="comprobarerrores()">
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-light border-right" id="sidebar-wrapper">
            ...
            <a href="editar-index-backoffice.php" class="list-group-item list-group-item-action bg-light"><i class="fas fa-home"></i>&nbsp;Usuarios</a>
...
?> </tbody>
                                    ...
                                    <input maxlength="100" disabled name=tipo autocomplete="off" type="text" required="required"
                                        class="form-control" placeholder="Buscar por nombre de Usuario o EMAIL" />
                                    <br>
...
?> </tbody>
                                    ...
                                    <hr>
                                    <input maxlength="100" disabled name=tipo autocomplete="off" type="text" required="required"
                                        class="form-control" placeholder="Buscar por nombre del hotel o EMAIL" />
                                    <br>
                                    <button style="width: 100%;" type="submit" class="btn btn-primary">Buscar</button>
                                </div>
                            </div>
                ...
                <div class="col-xs-12 col-md-12 col-xl-12">
                    <div class="card-in-u-u shadow2">
                        ...
                        <div class="row setup-content justify-content-center">
                            ...
                            <br>
                                <button style="width: 70%;" type="submit" class="btn btn-primary">CREAR</button>
                                </form>
                            </div>
                        </div>
                    </div>
