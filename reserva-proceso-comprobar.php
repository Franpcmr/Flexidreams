...
<div id=top-bar-pc class="row justify-content-center">
    ...
    <li>
        <a href="en/reserva-proceso-comprobar.php"> EN | </a>
    </li>
    <li>
        <a href="al/reserva-proceso-comprobar.php"> AL </a>
    </li>
</ul>
    ...
    <div class=container-fluid>
        ...
        <div id=panelreserva2 class="row justify-content-center">
                            ...
                            <div class="card-body">
                                <div class="row justify-content-center">
                                    ...
                                    <div align=center class="col-xl-4 col-md-6 col-xs-12">
                                        <label style="width: 80%;" class="control-label">Nombre
                                            <input type="text" class="form-control" placeholder="" value=""
                                                aria-describedby="basic-addon1">
                                        </label>
                                    </div>
                                    <div align=center class="col-xl-4 col-md-6 col-xs-12">
                                        <label style="width: 80%;" class="control-label">Apellidos
                                            <input type="text" class="form-control" placeholder="" value=""
                                                aria-describedby="basic-addon1">
                                        </label>
                                    </div>
                                    <div align=center class="col-xl-4 col-md-6 col-xs-12">
                                        <label style="width: 60%;" class="control-label">DNI
                                            <input type="text" class="form-control" placeholder="" value=""
                                                aria-describedby="basic-addon1">
                                        </label>
                                    </div>
                                    <div align=center class="col-xl-4 col-md-6 col-xs-12">
                                        <label style="width: 80%;" class="control-label">Telefono
                                            <input type="text" class="form-control" placeholder="" value=""
                                                aria-describedby="basic-addon1">
                                        </label>
                                    </div>
                                    ...
                                    <div align=center class="col-xl-12 col-md-6 col-xs-12">
                                        <label style="width: 80%;" class="control-label">Comentarios
                    ...
                    <div id=carta-info-reserva class="col-xl-4 col-md-4 col-xs-12">
                        <div id=carta-info-reserva_1 class="row justify-content-center">
                            <div id=carta-info-reserva_2 class="col-xl-8 col-md-8 col-xs-8">
                                ...
                                <h4 align=center>
                                    <br>Fechas<br><?php echo $fechaseleccionadadesde . " - " . $fechaseleccionadahasta ?>
                                </h4>
                                <br><br>
                                <h3 align=center>Adultos: <?php echo $adultos?></h3>
                                <br><br>
            ...
            <div align=center style="padding-bottom: 10px;" class="col-xl-12 col-md-12 col-xs-12">
                ...
                Acepto los terminos y condiciones de Flexidreams. <a href="">VER MAS</a>
                <hr>
